...
TEMPLATE_LIST_TEST_CASE("WorkDivMembers", "[workDiv]", alpaka::test::TestAccs)
{
    ...
    // call without explicitly specifying template parameter types
    ...
    auto const ref2DimUsingStdArr = alpaka::createWorkDiv{ara, arb, arc};
